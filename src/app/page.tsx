  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="relative z-10">
        <section id="about" className="relative pt-24 sm:pt-28 md:pt-32 pb-10 sm:pb-16 md:pb-20 flex items-center justify-center">
              ...
              <ContainerScroll
                titleComponent={
                  <h2 className="text-4xl font-semibold text-white text-center">
                    A showcase of my<br />
                    <span className="text-4xl sm:text-6xl md:text-[8rem] font-bold mt-1 leading-none">Technical Skills</span>
                  </h2>
                }
              >
                  ...
                  <div key={i} className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {skill.tags.map((tag, j) => (
                        <span key={j} className="text-xs px-3 py-1.5 rounded-full bg-white/5 border border-zinc-700 text-zinc-300">{tag}</span>
                      ))}
                    </div>
                  </div>
                ))}
